...
> ⚠️ **Lengkapi bagian bertanda `[ISI DI SINI]` dengan data Anda sendiri sebelum dikumpulkan.**
...
> [ISI DI SINI — tempelkan screenshot halaman Beranda, Daftar Buku, Tambah Buku, dan Edit Buku]

```
contoh:
![Beranda](assets/screenshot-beranda.png)
![Daftar Buku](assets/screenshot-daftar.png)
![Tambah Buku](assets/screenshot-tambah.png)
![Edit Buku](assets/screenshot-edit.png)
```
...
*(Sesuaikan kalimat di atas dengan kondisi pengerjaan Anda yang sebenarnya, dan
jelaskan juga secara lisan di video YouTube sesuai instruksi UAS.)*
